...
rho0 = 0.40 * np.ones(num_divs)
# rho0 = np.linspace(0.2, 0.9, len(x))


traffic = tf.TrafficFlow(h=h, k=k, x=x, total_time=20, rho0=rho0, f=f, df=df, u_to_rho=u_to_rho, rho_to_u=rho_to_u)
